...
export default function privacy() {
  ...
  // Raw HTML privacy policy was imported from the previous website.
  const htmlString = `
    <style>
      #ppBody {
        font-size: 11pt;
    ...
    <div id='ppHeader'>hackpsu.org Privacy Policy</div>
    <div id='ppBody'>
      ...
      <br/>
      <div class='grayText'>
        <strong>What personal information do we collect from the people that visit our blog, websiteor app?</strong>
      </div>
      <br/>
      <div class='innerText'>
      ...
      <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <strong>&bull;</strong> To administer a contest, promotion, survey or other site feature.
      </div>
      ...
      <div class='innerText'>
        <strong>
          ...
          can email us at technology@hackpsu.org
        </strong>
      </div>
    ...
    <div class='innerText'>hackpsu.org</div>
    <div class='innerText'>Old main</div>
    State College, Pennsylvania 16803
    <div class='innerText'>United States</div>
    <div class='innerText'>technology@hackpsu.org</div>
    <div class='innerText'>
      <br/>
