...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-full mx-auto text-justify text-sm bg-white pl-4 pr-4">
      <div className="font-verdana text-3xl text-center mb-4">hackpsu.org Privacy Policy</div>
      <div>
        ...
        <div className="my-2">
          ...
          <a href="https://support.google.com/adwordspolicy/answer/1316548?hl=en" target="_blank" rel="noopener noreferrer" className="text-blue-500">Learn more</a>
        </div>
        <div className="my-2">
        ...
        <div className="my-2">
          If at any time you would like to unsubscribe from receiving future emails, you can email us at technology@hackpsu.org and we will promptly remove you from ALL correspondence.
        </div>
        <div className="text-blue-500 my-2">
