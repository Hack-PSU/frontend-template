...
const PrivacyPolicy = () => {
	return (
		<div className="max-w-full mx-auto text-justify text-sm bg-white pl-4 pr-4">
			...
			<div>
				<div className="hidden">
					<div className="grid grid-cols-6 gap-4 text-center">
						<div className="col-span-1">Information Collection</div>
						<div className="col-span-1">Information Usage</div>
						<div className="col-span-1">Information Protection</div>
						<div className="col-span-1">Cookie Usage</div>
						<div className="col-span-1">3rd Party Disclosure</div>
						<div className="col-span-1">3rd Party Links</div>
					</div>
				</div>
				<div className="my-2">
					<strong>
				...
				<div className="my-2">We use regular Malware Scanning.</div>
				<div className="my-2">
				...
				<div className="my-2">Users can visit our site anonymously.</div>
				<div className="my-2">
					Once this privacy policy is created, we will add a link to it on our
					home page or, at a minimum, on the first significant page after
				...
				<div className="my-2">
					<strong>Can change your personal information:</strong>
				</div>
				<div className="ml-8 my-2 list-disc">
					<ul>
				...
				<div className="my-2">
					...
					emails, you can email us at technology@hackpsu.org and we will
				...
				<div className="my-2">hackpsu.org</div>
				<div className="my-2">Old main</div>
				<div className="my-2">State College, Pennsylvania 16803</div>
				<div className="my-2">United States</div>
				<div className="my-2">technology@hackpsu.org</div>
				<div className="my-2">Last Edited on 2018-02-27</div>
			</div>
		</div>
	);
};
