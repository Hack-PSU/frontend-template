...
const FullScreenLoading: React.FC = () => {
	return (
		<div
			...
			style={{
				background:
					"linear-gradient(to bottom, #B1E8FF 0%, #84cefe 50%, #215172 100%)",
			}}
		>
			{/* Animated Beach Ball */}
			<motion.div
			...
			<div className="absolute bottom-0 w-full h-32 overflow-hidden">
				<motion.div
					...
					style={{
						background:
							"linear-gradient(to top, rgba(33,81,114,0.8) 0%, transparent 100%)",
					}}
					initial={{ x: "-100%" }}
					animate={{ x: "100%" }}
					transition={{
				...
				<motion.div
					...
					style={{
						background:
							"linear-gradient(to top, rgba(0,218,183,0.6) 0%, transparent 100%)",
					}}
					initial={{ x: "100%" }}
					animate={{ x: "-100%" }}
					transition={{
