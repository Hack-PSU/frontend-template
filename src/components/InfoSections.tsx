            ...
            <div className="w-full max-w-7xl mx-auto space-y-[8vw]">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-[4vw]">
                    ...
                    <motion.div 
                        ...
                        animate={{ rotate: order.findIndex(s => s.id === order[0].id) * -120 }}
                        transition={{ type: "spring", stiffness: 200, damping: 25, duration: 0.8 }}
                    >
                        {order.map((section, idx) => {
                            const containerRotation = order.findIndex(s => s.id === order[0].id) * -120;
                            return (
                                <Hex
                                    key={section.id}
                                    section={section}
        ...
        >
            ...
            <motion.span
                ...
                style={{ 
                    ...
                    fontSize: isSelected ? 'clamp(16px, 3vw, 24px)' : 'clamp(12px, 2vw, 16px)',
                    fontFamily: 'Monomaniac One, monospace'
                }}
