    ...
    <section id="prizes" className="flex flex-col items-center w-full mt-20">
      ...
      <div className="w-11/12 md:w-5/12 p-3 bg-black rounded-lg text-center mt-20">
        <p className="text-lg text-left text-white">
          ...
          You can edit it until 1:45 PM Sunday.
          This is a hard deadline - the submission portal closes at 12 PM and
          any projects not submitted will not be considered for prizes.
        </p>
      </div>
    </section>
  );
  ...
  return (
    <section>
      <div className="carousel-container">
        <div className="carousel carousel--translate">
          ...
          <input
            ...
            type="radio"
            name="carousel"
            checked={slideNum == 0} onChange={doNothing}
          />
          <input
            className="carousel__activator"
            type="radio"
            name="carousel"
            checked={slideNum == 1} onChange={doNothing}
          />
          <input
            className="carousel__activator"
            type="radio"
            name="carousel"
            checked={slideNum == 2} onChange={doNothing}
          />
          <input
            className="carousel__activator"
            type="radio"
            name="carousel"
            checked={slideNum == 3} onChange={doNothing}
          />
      ...
      <div className="flex flex-row w-1/2 mx-auto mt-4 md:mt-0">
        <ArrowCircleLeft className="mx-auto carousel-arrow-icon" onClick={() => {
          setSlideNum(slideNum > 0 ? slideNum - 1 : 3);
        }}/>
        <ArrowCircleRight className="mx-auto carousel-arrow-icon" onClick={() => {
