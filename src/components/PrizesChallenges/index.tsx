...
const PrizesChallenges = () => {
	return (
		<section id="prizes" className="flex flex-col items-center w-full mt-20">
			...
			<div className="w-11/12 md:w-5/12 p-3 bg-[rgba(0,0,0,0.5)] border-[green] border-4 rounded-lg text-center mt-20">
				<p className="text-lg text-left text-white">
					...
					. Make sure to submit your project (even if not completed) on Devpost
					by 12 PM Sunday! You can edit it until 1:45 PM Sunday. This is a hard
					deadline - the submission portal closes at 12 PM and any projects not
					submitted will not be considered for prizes.
				</p>
			</div>
		</section>
	);
