	...
	const floors: Floor[] = [
		{
			...
			rooms: [
				...
				},
				{
					...
					name: "Room 124",
					roomNumber: "124",
					description: "Rooom 124 is closed for the event.",
					path: "M229.458 316.152 242.171 248.82 333.517 268.596 320.804 336.87Z",
					type: "offlimits",
					color: roomColors.offlimits,
					position: [280, 300],
				},
				{
					id: "room-125",
					name: "Room 125",
					roomNumber: "125",
					description: "Room 125 is closed for the event.",
					path: "M332.888 268.744 321.029 334.933 411.211 354.238 422.518 287.222Z",
					type: "offlimits",
					color: roomColors.offlimits,
					position: [370, 310],
				},
				{
					...
					name: "Room 126",
					roomNumber: "126",
					description: "Room 126 is closed for the event.",
					path: "M422.83 287.869 519.134 308.056 506.558 374.244 409.923 355.712Z",
					type: "offlimits",
					color: roomColors.offlimits,
					position: [460, 330],
				},
				{
					id: "room-123D",
					name: "Room 123D",
					description: "Room 123D is a hacking space.",
					path: "M241.585 152.987 275.231 159.835 270.141 187.988 236.816 180.502Z",
					type: "hacking",
				...
				},
				{
					id: "room-123E",
					name: "Room 123E",
					description: "Room 123E is a hacking space.",
					path: "M269.899 187.746 265.311 211.411 231.745 203.201 236.575 180.502Z",
					type: "hacking",
					color: roomColors.hacking,
					position: [250, 200],
				},
