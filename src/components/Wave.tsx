...
const Wave: React.FC<WaveProps> = ({
    ...
    useEffect(() => {
        ...
        function calculateWavePoints(factor: number, offset: number = 0) {
            ...
            for (let i = 0; i <= wavePoints; i++) {
                ...
                const yPos = Math.sin(sinSeed / 100) * sinHeight + waveHeight + offset;
                pts.push({ x, y: yPos });
            }
            return pts;
        }
        ...
        function tick() {
            ...
            if (lastTime !== null) {
                ...
                if (borderColor && borderEl) {
                    const borderPts = calculateWavePoints(factor, borderOffset);
    ...
    }, [width, height, waveHeight, waveDelta, speed, wavePoints, borderColor, borderOffset]);
