				...
				>
					<ul className="list-inside list-disc text-white font-lato text-lg md:text-lg shadowtext-on-grid">
						<li key={0}>
							...
							year). All participants must bring a valid form of identification.
						</li>
						<li key={1}>
							Teams may be comprised of up to five members. A team may only
							submit one project, and no participant may be a member of multiple
							teams.
						</li>
						<li key={2}>
